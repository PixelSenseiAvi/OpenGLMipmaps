...
void Model::LoadMesh(aiMesh * mesh, const aiScene * scene)
{
	...
	for (size_t i = 0; i < mesh->mNumVertices; i++)
	{
		...
		//test
		//publicVertices.insert(publicVertices.end(), { glm::vec3(mesh->mVertices[i].x, mesh->mVertices[i].y, mesh->mVertices[i].z)});
	...
	publicVertices = vertices;
	publicIndices = indices;
}
